...
# ==================================== Train Config ========================
PROJECT_NAME="swepdb-ablation"
EXPERIMENT_NAME="rewrite-qwen3-14b"
...
MODEL_PATH="${SWE_PDB_MODEL_PATH:-Qwen/Qwen3-14B}"  # Or your local checkpoint path
...
ROLLOUT_DATA_DIR="${PROJECT_ROOT}/train_trajectories/${PROJECT_NAME}/${EXPERIMENT_NAME}/rollout"
VALIDATION_DATA_DIR="${PROJECT_ROOT}/train_trajectories/${PROJECT_NAME}/${EXPERIMENT_NAME}/val"


# Find the directory where rllm package is located
RLLM_DIR=$(python3 -c "import rllm; import os; print(os.path.dirname(os.path.dirname(rllm.__file__)))")

# Set PYTHONPATH to ensure Ray workers can find rllm module
...
python3 -m rllm.trainer.verl.train_agent_ppo \
    ...
    +rllm.env.env_args.enable_pdb=False \
    ...
    +rllm.agent.agent_args.scaffold=rewrite \
