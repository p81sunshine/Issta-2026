...
ENV_CLASSES = {
    ...
    "swe_bench_debug_gym": safe_import("rllm.environments.debug_gym.swe_bench_env", "SWEBenchDebugGymEnv"),
    "kodcode_debug_gym": safe_import("rllm.environments.debug_gym.kodcode_env", "KodCodeDebugGymEnv"),
...
AGENT_CLASSES = {
    ...
    "debug_gym_agent": safe_import("rllm.agents.debug_gym_agent", "DebugGymAgent"),
}
